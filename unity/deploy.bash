...
SOURCES=`sed 's/.*/            "&",/' < ${SCRIPT_DIR}/sources.list`

JAMFILE="${DEPLOY}/SDL2_sources.jam.cs"
cat > "${JAMFILE}" <<EOF
// This file is automatically generated by deploy.bash

namespace External.SDL2
{
    static class SDL2_sources
    {
        internal static string[] SDL_sources = 
        {
${SOURCES:0:-1}
        };

        internal static string[] GetSources()
        {
            return SDL_sources;
        }
    }
